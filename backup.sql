...
/*!50503 SET character_set_client = cp850 */;
CREATE TABLE `admin` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=cp850 COLLATE=cp850_0900_ai_ci;
...
CREATE TABLE `admins` (
  ...
  `username` varchar(255) DEFAULT NULL,
  PRIMARY KEY (`adminId`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=cp850 COLLATE=cp850_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=11 DEFAULT CHARSET=cp850 COLLATE=cp850_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=cp850 COLLATE=cp850_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=15 DEFAULT CHARSET=cp850 COLLATE=cp850_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
